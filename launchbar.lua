...
function launchbar.new()
   ...
   widget:add( launcher({ command = "/home/mk/launch_virt_manager.sh", image = "/usr/share/icons/hicolor/48x48/apps/virt-manager.png" }) )
   widget:add( separator )
   ...
   widget:add( launcher({ command = "/home/mk/create_screenshot.sh", image = "/usr/share/icons/nuoveXT2/48x48/apps/gnome-screenshot.png" }) )
